      ...
      <div className={styles.container}>
        <div className={styles.leftSection}>
          {enableSideMenu ? (
            ...
            >
              {isMenuOpen ? (
                <svg className={styles.burgerIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"/></svg>
              ) : (
                <svg className={styles.burgerIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
              )}
            </button>
          ) : (
            <button
        ...
        <div className={styles.middleSection}>
          <div className={styles.searchWrapper}>
            <svg className={styles.searchIcon} onClick={() => handleSearch(searchValue)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0"/>
            </svg>
            <input
              type="text"
        ...
        <div className={styles.userSection}>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 17h4V5H2v12h3m15 0h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5v8h1"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>
          </button>
          ...
          <div className={styles.accountWrapper} ref={dropdownRef}>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.875" d="M15.997 6.998a3.998 3.998 0 1 1-7.995 0 3.998 3.998 0 0 1 7.995 0M12 14.003A7 7 0 0 0 5.002 21h13.995A7 7 0 0 0 12 14.003"/></svg>
            </button>
